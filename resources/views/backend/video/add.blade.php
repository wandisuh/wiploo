	  ...
	  <!--<div class="col-md-12 col-xs-12">-->
		<div class="x_panel">
		  ...
		  <div class="x_content">
			...
			<form class="form-horizontal form-label-left" method="POST" action="{{ route('store-video') }}" enctype="multipart/form-data">
				{{ csrf_field() }}
			  <div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Judul Video</label>
			  ...
			  <div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">File Video</label>
				<div class="col-md-4 col-sm-9 col-xs-12">
				  <input type="file" class="form-control" value="{{ old('file_video') }}" name="image">
				</div>
			  </div>
        <div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Atau Embed Video</label>
				<div class="col-md-5 col-sm-9 col-xs-12">
				  <textarea name="embed_video" rows="6" class="form-control">{{ old('embed_video') }}</textarea>
				</div>
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
				<div class="col-md-9 col-sm-10 col-xs-12 col-md-offset-3">
				  <a type="button" class="btn btn-primary" href="{{ route('data-video') }}">Cancel</a>
